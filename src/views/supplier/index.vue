...
-->
    ...
    <div class="table-box" >
      ...
      >
        ...
        <el-table-column prop="supplierName" label="运营商名称" align="center"/>

        <el-table-column prop="supplierContact" label="联系人信息" align="center" />

        <el-table-column prop="supplierPhone" label="联系人手机号" align="center"  />

        <el-table-column prop="supplierEmail" label="联系人邮箱" align="center"  />

        <el-table-column prop="supplierBrank" label="开户行" align="center"  />
